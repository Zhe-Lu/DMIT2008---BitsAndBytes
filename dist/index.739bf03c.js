...
var _firebaseConfig = require("./libs/firebase/firebaseConfig");
...
async function pageInit() {
    ...
    products.forEach((product)=>{
        document.querySelector('.product-display').appendChild(_product.renderProduct(product));
    });
}
...
},{"firebase/database":"bpqHw","./libs/firebase/firebaseConfig":"db0eO","./templates/product":"ei5jF"}],"bpqHw":[function(require,module,exports) {
...
},{}],"db0eO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/app":"3AcPV","@firebase/util":"ePiK6","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ei5jF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function onDeleteProduct(e) {
    ...
    const ref = _database.ref(_firebaseConfig.db, 'products/' + key);
    _database.set(ref, null);
}
